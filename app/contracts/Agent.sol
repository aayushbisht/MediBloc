...
contract Agent {
    ...
    string[] public patientDetails;
    string[] public doctorDetails;
    ...
    function get_doctor_list() public view returns(address[] memory ){
     ...
     function get_patient_details() public view returns(string[] memory ){
        return patientDetails;
    }

    function get_doctor_details() public view returns(string[] memory ){
